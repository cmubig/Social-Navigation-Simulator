...
def main():
    ...
    #radius=Config.STATIC_MAP_GRID_CELL_SIZE
    radius=3*Config.STATIC_MAP_GRID_CELL_SIZE
    agents = tc.get_testcase_two_agents_maps(policies, radius=radius, sensors=sensors)
