...
def plot_episode(agents, in_evaluate_mode,
    ...
    #######
    #Add legend to identify color representation of algorithm
    ...
    unique_agent_policy_color_list = list([ plt_colors[ unique_agent_policy_name_list.index(policy_name) ] for policy_name in unique_agent_policy_name_list])
##    print("unique_agent_policy_name_list")
##    print(unique_agent_policy_name_list)
##
##    print("unique_agent_policy_color_list")
##    print(unique_agent_policy_color_list)

    
    unique_agent_policy_color_list = [ ptch.Patch(color=color, label=algo_name)  for color,algo_name in zip(unique_agent_policy_color_list,unique_agent_policy_name_list) ]
    

    plt.legend(handles=unique_agent_policy_color_list,loc="upper right", prop={'size': 10})
...
##        print("policies list to test")
##        print(agent_policy_name_list)
##        print("agent policy name")
##        print(agent.policy.str)
