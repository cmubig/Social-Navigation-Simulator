...
class TrajectoryGenerator(nn.Module):
    ...
    def forward(self, obs_traj, obs_traj_rel, seq_start_end, aux_input=None, user_noise=None):
        """
        Inputs:
        - obs_traj: Tensor of shape (obs_len, batch, 2)
...
class TrajectoryIntention(nn.Module):
    ...
    def forward(self, obs_traj, obs_traj_rel, seq_start_end, goal_input=None):
        """
        Inputs:
